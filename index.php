...
<div class="contener" >
    <div class="nav-bar ">
        <a href="index.php?lang=en" style="text-decoration:none; "><?php echo $lang['lang_en'] ;?> | </a>
         <a href="index.php?lang=fr"style="text-decoration:none; "><?php echo $lang['lang_fr'] ;?></a>
    </div>
</div>    
</body>
</html>
    ...
    <table id="emi" width="100%">
        ...
        <tr>
            <td colspan="3">
                ...
                <input type="submit" value="Compute and Reset"  name="EMI_submit" class="btn btn-primary">
...
if(!empty($_POST['principal']) || !empty($_POST['interest']) || !empty($_POST['years'])){
    ...
    <tr>
        ...
        <td>
            <?php echo $lang['Beginning_Balance']; ?>
        </td>
        <td>
            <?php echo $lang['Principle']; ?>
        </td>
        <td>
            <?php echo $lang['Total_Payment']; ?>
        </td>
        <td>
            <?php echo $lang['Ending_Balance']; ?>
        </td>
    </tr>
    <?php
...
<?php
//$principleloan=60;//instead of 60 assign another value or variable
//$totalintrest=40;//instead of 40 assign another value or variable
$principleloan=$monthly;
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
         ['amount','percent'],    
         ['<?php echo $lang['piechart monthly payment']; ?>', <?php echo $principleloan ?> ],
         ['<?php echo $lang['piechart total intrest']; ?>',  <?php echo $totalintrest ?> ],
         ['<?php echo $lang['piechart total payment']; ?>',<?php echo $totalint1 ?>]
        ]);

        var options = {
          title: '<?php echo $lang['piechart breakup']; ?>'
        };
